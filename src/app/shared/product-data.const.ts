...
export const SHOP_DATA: Product[] = [
    ...
    {name: 'Сок', code: 2, photo: '2', brand: 'Фруктовый сад', price: 70, crossedPrice: 100, datePublished: new Date(),isActive: true},
    ...
    {name: 'Газировка', code: 5, photo: '5', brand: 'Золотой ключик', price: 55, crossedPrice: 85, datePublished: new Date(),isActive: true},
    ...
    {name: 'Мясо', code: 9, photo: '9', brand: 'Агрокомплекс', price: 50, crossedPrice: 70, datePublished: new Date(),isActive: true},
